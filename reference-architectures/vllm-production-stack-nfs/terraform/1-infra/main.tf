...
# Note: The Terraform provider outputs mount_path but not the NFS host.
# The host must be retrieved from the DigitalOcean console or API for kubectl configuration.
