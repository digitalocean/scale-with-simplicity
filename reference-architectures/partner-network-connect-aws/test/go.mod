module github.com/digitalocean/scale-with-simplicity/reference-architectures/partner-network-connect-aws/test
...
require (
	...
	github.com/digitalocean/godo v1.153.0 // indirect
